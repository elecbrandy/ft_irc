...
const std::map<std::string, Client*>& IrcServer::getNickNameClientMap() const {return (this->nickNameClientMap);}

std::map<std::string, Channel*>& IrcServer::getChannels() {return (this->_channels);}
